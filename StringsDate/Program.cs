...
var Soyadı = Console.ReadLine();

Console.Write("Yaşı: ");
var Yaşı = Console.ReadLine();

//string concat 
// string mesaj = Adı + " " + Soyadı + " " + Yaşı + " yaşındadır.";
...
DateTime dt = new DateTime(2023, 10, 1, 12, 30, 0);
